...
def again(): #<-- function header
    ...
    while ans != "y" and ans != "n":
        print("***INVALID ENTRY***")
        ans = input("\t\tWould you like to enter another temperature? [y/n]: ")
    
    return ans # this value will replace the function call in the main code

def converter(f):
    # f is a parameter
    '''this function is passed an argument value of f (tempF), converts to tempC, and then returns the conversion value'''
    c = (f - 32) * (5 / 9)
